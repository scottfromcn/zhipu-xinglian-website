...
export function AboutPage() {
  return <SiteLayout><PageHero eyebrow="关于智谱星连" title="连接 AI 能力与企业实际业务" description="江苏智谱星连聚焦工业智能与国企办公，以平台产品承接模型能力，以场景方案推动 AI 进入企业工作流程。" />
    <section className="section-pad"><div className="site-shell"><SectionHeading title="两条业务主线，面向明确需求" /><div className="two-grid"><article className="content-card"><p className="eyebrow">工业智能</p><h3>平台与场景协同</h3><p>以星连工业智能体平台组织供给、运行与治理，结合企业实际需求提供工业 AI 解决方案。</p><ActionLink to="/industrial-platform" secondary>了解工业平台</ActionLink></article><article className="content-card"><p className="eyebrow">国企办公</p><h3>OfficeAI 产品组合</h3><p>以 TokenHub、SkillHub、Agent Admin 和 OfficeAgent 构成完整办公方案，连接员工使用与企业管理。</p><ActionLink to="/office-ai" secondary>了解 OfficeAI</ActionLink></article></div></div></section>
