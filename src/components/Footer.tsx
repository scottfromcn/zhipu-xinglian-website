...
export default function Footer() {
  return <footer className="site-footer"><div className="site-shell">
    <div className="footer-grid">
      <div><Link to="/" className="brand"><span className="brand-mark">Z</span><span>智谱星连</span></Link><p>让可信 AI 深入工业现场，走进国企办公。</p><p className="footer-note">数据可信 · Agent 可信 · 环境可信<br />工业平台：SaaS / 私有化一体机<br />OfficeAI：全部私有化部署</p></div>
